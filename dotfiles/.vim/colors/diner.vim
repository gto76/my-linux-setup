...
hi Normal guifg=black guibg=white ctermfg=DarkMagenta
hi Constant term=underline ctermfg=black guifg=Black
hi Special term=bold ctermfg=DarkRed guifg=black
hi Identifier term=underline ctermfg=DarkMagenta guifg=black
hi Statement term=bold ctermfg=DarkYellow gui=NONE guifg=Brown
hi PreProc term=underline ctermfg=DarkMagenta guifg=Purple
hi Type term=underline ctermfg=DarkCyan gui=NONE guifg=DarkRed:
